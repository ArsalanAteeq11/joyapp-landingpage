...
import { Send, MapPin, Phone, Mail, Linkedin, Twitter } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-10">
              Have questions about Joy App? Our team is here to help you find 
              the perfect solution for your property management needs.
            </p>
            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+974 4000 0000</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">hello@joyapp.qa</p>
                </div>
              </div>
            </div>
